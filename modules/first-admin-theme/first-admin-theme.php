...
class First_Admin_Theme {
	...
	function admin_scripts() {
		...
		wp_register_style( 'style', plugin_dir_url(__FILE__).( "scss/scss.php/admin_bar.scss" ), array());
		...
		if( $this->get_setting('theme_color') !== 'default' ){
			wp_register_style( 'color', plugin_dir_url(__FILE__).( "scss/scss.php/admin_menu.scss" ), array());
